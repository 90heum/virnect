<template>
  <header>
    <div class="headerInner">
        <div class="logo">
                <nuxt-link to="/">
                    <img src="https://velog.velcdn.com/images/kyj0206/post/9ebd4dfa-26bb-4b50-bb22-9350ed0089b7/image.png"
            ...
            <div class="navWrap">
                ...
                <nav>
                    <ul>
                        <li v-for="(list, idx) of navList" :key="idx">
                             <a class="navTab container2">
                                {{list.title}}
                                <i>
                                    <img class="downIcon2"
                ...
                <div class="serviceSelect" @click="showServiceMenu">
                    <div class="select">
                        ...
                        <ul v-if="showMenu">
                            <li v-for="(list, idx) of optionList" :key="idx" class="option" @click="showServiceMenu">
                                <a href="#">
                                    <p>
                                        {{list.title}}
                                    </p>
                ...
                <div class="language" @click="langlang()">
                    <i>
                        ...
                        <div class="languageWrapWeb" v-if="showEarth">
                            <span
        ...
        <div class="subNavi subNavSolutions">
            <div class="subNavSolutionsInner">
                ...
                <span class="asideInfoLink">
                    ...
                    <div>
                        <a href="#">
                            모든 인사이트 보기
                            <i>
                                <img src="https://velog.velcdn.com/images/kyj0206/post/6d82fca8-fda9-4286-9b2b-597c38cda81f/image.png"
                                    alt="#">
                            </i>
                        </a>
                    </div>
                ...
                <!-- 프로덕트 서브메뉴 박스 -->
        <div class="subNavi subNavProducts">
        ...
        <div class="subNavi subNavSupport">
            <div class="subNavSupportInner">
                <div>
                    <span>
                        ...
                        <div class="subNavSupportMenu">
                            <span>
                                <ul>
                                    <li><a href="#"><span>Product Notice</span></a></li>
                                    <li><a href="#"><u>-릴리즈 노트</u></a></li>
                                    <li><a href="#"><u>-안내</u></a></li>
                                    <li><a href="#"><u>-점검</u></a></li>
                                    <li><a href="#"><u>-장애</u></a></li>
                                </ul>
                            </span>
                            <span>
                                <ul>
                                    ...
                                    <div class="FAQWrap">
                                        <li><a href="#"><u>-회원</u></a></li>
                                        <li><a href="#"><u>-제품</u></a></li>
                                        <li><a href="#"><u>-결제</u></a></li>
                                        <li><a href="#"><u>-서비스</u></a></li>
                                        <li><a href="#"><u>-기기</u></a></li>
                                        <li><a href="#"><u>-기타</u></a></li>
                                    </div>
                                </ul>
                            </span>
                            <span>
                                <ul>
                                    <li><a href="#"><span>학습센터</span></a></li>
                                    <li><a href="#"><u>-VIRNECT Remote</u></a></li>
                                    <li><a href="#"><u>-VIRNECT Make</u></a></li>
                                    <li><a href="#"><u>-VIRNECT View</u></a></li>
                                </ul>
                            </span>
                            <span>
                                <ul>
                ...
                <span class="asideInfoLink">
                    <a href="#">
                        <img src="https://velog.velcdn.com/images/kyj0206/post/7562cf58-2e5a-469b-920c-0b43be5a0f4c/image.png"
                            alt="서포트이미지">
                    </a>
                </span>
            </div>
        ...
        <div class="subNavi subNavNewsrooom">
            <div class="subNavNewsrooomInner">
                ...
                <span class="asideInfoLink">
                    <a href="#">
                        <img src="https://velog.velcdn.com/images/kyj0206/post/5eeeaef0-66f2-47e9-b36d-6a193a7412d8/image.png"
                            alt="뉴스룸 이미지">
                    </a>
                </span>
            </div>
        ...
        <div class="subNavi subNavCompany">
            <div class="subNavCompanyInner">
                <div>
                    <span>
                        <span class="subNavCompanyTit">
                            글로벌 No.1 XR 플랫폼 기업으로
                            <p>도약을 준비하고 있습니다.</p>
                        </span>
                ...
                <span class="asideInfoLink">
                    ...
                    <a href="#">
                        <img src="https://velog.velcdn.com/images/kyj0206/post/f1f9bdfc-bd63-42a8-8083-72003e7bfbd4/image.png"
                            alt="컴퍼니 이미지">
                    </a>
                </span>
            </div>
...
<script>
import Solution from "./Gnb/Solution/index.vue";
import Products from "./Gnb/Products/index.vue";
import Pricing from "./Gnb/Pricing/index.vue";
import Company from "./Gnb/Company/index.vue";
import Contact from "./Gnb/Contact/index.vue";
import FreeTrials from "./Gnb/FreeTrials/index.vue";
...
export default {
  computed: {
    ...
    created() {
        if (process.client) { window.addEventListener('scroll', this.handleReactiveView)};
    },
  beforeDestroy() {
   if (process.client) window.removeEventListener('scroll', this.handleReactiveView)
    // window.removeEventListener('scroll', this.hasScrolled)
  },    
  components: { Solution, Products, Pricing, Company, Contact, FreeTrials, snbSection, SubSolutionMenu },
  ...
  methods: {
    ...
    hidebox() {
      if (this.show == true) {
        ...
        this.pricingShow = false;
        this.contactShow = false;
        this.freeTrialsShow = false;
        this.show = false;
      }
    },
