    ...
    <div class="detailCompany">
        ...
        <div class="detailCompanyWrap">
            ...
            <span class="contHead">
                <span>
                    <h2>
                        {{$i18n.localeProperties.code === "ko" ? irContentData.title : irContentData.titleEn}}
                    </h2>
                </span>
                <span>
            ...
            <!-- 블로그 -->
            <span class="detailBlog" v-html="$i18n.localeProperties.code === 'ko' ? irContentData.content : irContentData.contentEn"></span>
            <!-- PreNext -->
            <span class="PreNext">
                <ul @click="requestData(irContentData.prevId ? irContentData.prevId : id)">
                    <li>
                    ...
                    <li>
                        <nuxt-link :to="`?id=${irContentData.prevId ? irContentData.prevId : id}`">
                            {{irContentData.prevTitle ? $i18n.localeProperties.code === "ko" ? irContentData.prevTitle : irContentData.prevTitleEn : "이전 글이 존재하지 않습니다."}}
                        </nuxt-link>
                    </li>
                    <li>
                        {{irContentData.nextPrevDate ? $dayjs(irContentData.prevCreatedDate).format("YYYY-MM-DD") : ""}}
                    </li>
                </ul>
                <ul @click="requestData(irContentData.nextId ? irContentData.nextId : id)">
                    <li>
                    ...
                    <li>
                        <nuxt-link :to="`?id=${irContentData.nextId ? irContentData.nextId : id}`">
                            {{irContentData.nextTitle ? $i18n.localeProperties.code === "ko" ? irContentData.nextTitle : irContentData.nextTitleEn : "다음 글이 존재하지 않습니다."}}
                        </nuxt-link>
                    </li>
                    <li>
                        {{irContentData.nextCreatedDate ? $dayjs(irContentData.nextCreatedDate).format("YYYY-MM-DD") : ""}}
                    </li>
                </ul>
            </span>
            <!-- 목록으로 -->
