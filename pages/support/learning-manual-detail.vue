            ...
            <div class="detailviewManualWrap">
                ...
                <span class="PreNext">
                    <ul @click="goToPage(contentList.prevId)">
                        ...
                        <li>
                            <nuxt-link :to="`learning-manual-detail?category=${contentList.prevId ? contentList.prevId : contentList.id}&type=${1}`">
                    ...
                    <ul @click="goToPage(contentList.nextId)">
                        ...
                        <li>
                            <nuxt-link :to="`learning-manual-detail?category=${contentList.nextId ? contentList.nextId : contentList.id}&type=${1}`">
...
export default {
    ...
    methods: {
        async goToPage (id) {
            if(!id) return;
            const data = await this.$axios.get(`admin/support/learning/${id}?typeId=${this.$route.query.type}`);
